...
[![Build status](https://ci.appveyor.com/api/projects/status/howa35u23wrdsgav?svg=true)](https://ci.appveyor.com/project/stormozov/object-reflection-proxy-1)
...
[
  ...
  {key: "defense", value: 40}, // порядок по алфавиту (т.к. в массиве с ключами нет значения "defense")
